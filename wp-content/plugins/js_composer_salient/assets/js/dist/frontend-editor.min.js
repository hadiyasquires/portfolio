...
! function(e) {
    _.isUndefined(window.vc) && (window.vc = {}), window.Vc_postSettingsEditor = Backbone.View.extend({
        ...
        initialize: function(t) {
            t && 0 < t.length && (this.sel = t), this.ace_enabled = !0
        },
        aceEnabled: function() {
            return this.ace_enabled && window.ace && window.ace.edit
        },
        setEditor: function(t) {
            if (!this.missingUnfilteredHtml()) return this.aceEnabled() ? this.setEditorAce(t) : this.setEditorTextarea(t), this.$editor
        },
        missingUnfilteredHtml: function() {
            return e("#" + this.sel).hasClass("wpb_missing_unfiltered_html")
        },
        focus: function() {
            var t;
            this.is_focused && (this.aceEnabled() ? (this.$editor.focus(), t = this.$editor.session.getLength(), this.$editor.gotoLine(t, this.$editor.session.getLine(t - 1).length)) : this.$editor.focus())
        },
        setEditorAce: function(t) {
            this.$editor || (this.$editor = ace.edit(this.sel), this.$editor.getSession().setMode("ace/mode/" + this.mode), this.$editor.setTheme("ace/theme/chrome")), this.$editor.setValue(t), this.$editor.clearSelection(), this.is_focused && this.$editor.focus();
            t = this.$editor.getSession().getLength();
            return this.$editor.gotoLine(t, this.$editor.getSession().getLine(t - 1).length), this.$editor
        },
        setEditorTextarea: function(t) {
            return this.$editor || (this.$editor = e("<textarea></textarea>").css({
                width: "100%",
                height: "100%",
                minHeight: "300px"
            }), e("#" + this.sel).empty().append(this.$editor).css({
                overflowLeft: "hidden",
                width: "100%",
                height: "100%"
            })), this.$editor.val(t), this.is_focused && this.$editor.focus(), this.$editor.parent().css({
                overflow: "auto"
            }), this.$editor
        },
        setSize: function() {
            var t = e(window).height() - 380;
            this.aceEnabled() ? e("#" + this.sel).css({
                height: t,
                minHeight: t
            ...
            o("body").off("click.vcGalleryWidget").on("click.vcGalleryWidget", ".gallery_widget_add_images", function(e) {
                ...
                e = o(this);
                   ...
                   if(jQuery('select[name=type]').length > 0 && jQuery('select[name=type]').val() == 'image_grid'){
                    ...
                    /* nectar addition end */ 
                c.vc_editor.$vc_editor_element = o(this), "true" === e.attr("use-single") ? c.VcSingleImage.frame(this).open("vc_editor") : (e.blur(), c.vc_editor.open("wpbakery"))
            })
        }
            ...
            try {
                _.isUndefined(tinyMCEPreInit.qtInit[a]) && (window.tinyMCEPreInit.qtInit[a] = _.extend({}, window.tinyMCEPreInit.qtInit[window.wpActiveEditor], {
                    ...
                    setup: function(e) {
                        ...
                        }), e.on("ExecCommand", t))) : e.onInit.add(function() {
                            window.wpActiveEditor = a
                        })
                    }
            ...
            o = Backbone.View.extend({
                ...
                parseData: function() {
                    _.each(this.$input.val().split("|"), function(e) {
                        var t;
                        e.match(/\:/) && (t = (e = e.split(":"))[0], e = e[1], this.data[t] = _.map(e.split(","), function(e) {
    ...
    void 0 === window.vc && (window.vc = {}), window.vc.ShortcodesBuilder = function(e) {
        ...
        build: function(e, t, n) {
            this.ajax({
                ...
                }, this), _.isFunction(t) && t(e), window.vc.frame.setSortable(), window.vc.activity = !1, this.checkNoContent(), window.vc.frame_window.vc_iframe.loadScripts(), this.last() && vc.frame.scrollTo(this.first()), this.models = [], this.showResultMessage(), this.is_build_complete = !0, vc.events.trigger("afterLoadShortcode"), n && this.buildDefaultCss(n)
            })
        },
        lastID: function() {
        ...
        buildFromTemplate: function(e, t) {
            ...
            return _.each(s(e), function(e) {
                ...
                var t, e = JSON.parse(decodeURIComponent(e + "")),
                    ...
                    i = _.isObject(e.attrs) ? e.attrs : {};
                o || (t = window.vc.shortcodeHasIdParam(e.tag)) && !_.isUndefined(i) && !_.isUndefined(i[t.param_name]) && 0 < i[t.param_name].length && (o = !0), t = window.vc.shortcodes.create({
                    id: e.id,
                    shortcode: e.tag,
                    params: this.unescapeParams(i),
                    parent_id: e.parent_id,
                    from_template: !0
                }), n.attr("data-model-id", t.get("id")), this._renderBlockCallback(n.get(0))
            }, this), window.vc.frame.setSortable(), window.vc.activity = !1, this.checkNoContent(), window.vc.frame_window.vc_iframe.loadScripts(), this.last() && window.vc.frame.scrollTo(this.first()), this.models = [], this.showResultMessage(), window.vc.frame.render(), this.is_build_complete = !0, o
        },
        ...
        renderShortcode: function(e, t) {
            var n, i = this.getView(t),
                o = e;
            window.vc.last_inner = o.html(), s("script", o).each(function() {
                var e;
            ...
            }), n && e.html(o.html()), t.get("from_content") || t.get("from_template") || this.placeContainer(e, t), t.view = new i({
                model: t,
                el: e
            }).render();
             /*nectar addition - do not trigger until after page is loaded */
             if(jQuery("#vc_preloader.hidden").length > 0) {
                this.notifyParent(t.get("parent_id"));
              }
              /*nectar addition end */
              t.view.rendered()
        },
        ...
        toString: function(e, t) {
            var n = {},
                ...
                o = window.vc.getMergedParams(i, e),
        ...
        save: function(status) {
            ...
            data.vc_post_custom_seo_settings = jQuery("#vc_post-custom-seo-settings").val();
            data.content = this.wpautop(string), status && (data.post_status = status, jQuery(".vc_button_save_draft").hide(100) && jQuery("#vc_button-update").text(window.i18nLocale.update_all)), window.vc.update_title && (data.post_title = this.getTitle()), this.ajax(data).done(function() {
        ...
        parse: function(r, e, d) {
            var w = _.keys(window.vc.map).join("|"),
                t = window.wp.shortcode.regexp(w),
                e = e.trim().match(t);
            return _.isNull(e) || _.each(e, function(e) {
                var t, n = e.match(this.regexp(w)),
                    i = n[5],
                    o = new RegExp("^[\\s]*\\[\\[?(" + _.keys(window.vc.map).join("|") + ")(?![\\w-])"),
                ...
                }, t = window.vc.getMapped(s.shortcode), _.isArray(r) ? (r.push(s), a = r.length - 1) : r[a] = s, a == s.root_id && (r[a].html = e), _.isString(i) && i.match(o) && (t.is_container && _.isBoolean(t.is_container) && !0 === t.is_container || !_.isEmpty(t.as_parent) && !1 !== t.as_parent) ? r = this.parse(r, i, r[a]) : _.isString(i) && i.length && "vc_row" === n[2] ? r = this.parse(r, '[vc_column width="1/1"][vc_column_text]' + i + "[/vc_column_text][/vc_column]", r[a]) : _.isString(i) && i.length && "vc_column" === n[2] ? r = this.parse(r, "[vc_column_text]" + i + "[/vc_column_text]", r[a]) : _.isString(i) && (r[a].params.content = i)
            }, this), r
        },
            ...
            if (e.settings && !t) {
                ...
                if (n && n.length)
                    for (var o = 0; o < n.length; o++)
                        if ("css_editor" === n[o].type) {
                            i = n[o].value;
                            break
                        }(t = i ? "." + e + "{" + _.reduce(i, function(e, t, n) {
                            return t ? e + n + ": " + t + ";" : e
    ...
    function(o) {
        window.vc.seo_utils = {
            getTextContent: function(e) {
                e = e.replace(/\s*\bdata-vcv-[^"<>]+"[^"<>]+"+/g, "").replace(/<!--\[vcvSourceHtml]/g, "").replace(/\[\/vcvSourceHtml]-->/g, "").replace(/<\//g, " </");
                for (var t = document.createRange().createContextualFragment(e), n = t.querySelector("style, script, noscript, meta, title, #vc_no-content-helper, .vc_controls"); n;) n.parentNode.removeChild(n), n = t.querySelector("style, script, noscript, meta, title, #vc_no-content-helper, .vc_controls");
                return t && t.textContent && t.textContent.trim()
            },
            createMeasurementElement: function() {
                var e = document.createElement("div");
                return e.id = "vc-measurement-element", e.style.position = "absolute", e.style.left = "-9999em", e.style.top = 0, e.style.height = 0, e.style.overflow = "hidden", e.style.fontFamily = "arial, sans-serif", e.style.fontSize = "20px", e.style.fontWeight = "400", document.body.appendChild(e), e
            },
            measureTextWidth: function(e) {
                var t = document.getElementById("vc-measurement-element");
                return (t = t || this.createMeasurementElement()).innerHTML = e, t.offsetWidth
            },
            findKeyphrase: function(e, t) {
                e = e.toLowerCase();
                t = (t = t.trim().toLowerCase()).replace(/[.*+?^${}()|[\]\\]/g, "\\$&"), t = new RegExp("\\b" + t + "\\b", "gi"), e = Array.from(e.matchAll(t));
                return e.length ? {
                    found: !0,
                    count: e.length,
                    positions: e.map(function(e) {
                        return e.index
                    })
                } : {
                    found: !1,
            ...
            findKeyphraseInSlug: function(e, t) {
                t = this.slugify(t), e = this.slugify(e), t = t.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"), e = e.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"), t = new RegExp("\\b" + t.split("-").join("\\b-\\b") + "\\b", "gi"), e = Array.from(e.matchAll(t));
                return 0 < e.length ? {
                    found: !0,
                    count: e.length,
                    positions: e.map(function(e) {
            ...
            findKeyphraseInAltTag: function(e, t) {
                var n = e.length,
                    r = 0;
                return t = t.trim().toLowerCase(), e.each(function() {
                    var e = o(this).attr("alt");
                    e && e.toLowerCase().includes(t) && r++
                }), {
                    percentage: r / n * 100,
                    imagesWithKeyphrase: r
                }
            },
            findKeyphraseDensity: function(e, t) {
                t = t.trim().toLowerCase();
                var n = e.trim().split(/\s+/).length,
                    t = new RegExp("\\b" + t + "\\b", "gi");
                return {
                    keyphraseOccurrences: e.match(t) || [],
                    advisedMinOccurrences: Math.ceil(.005 * n),
                    advisedMaxOccurrences: Math.ceil(.03 * n)
                }
            },
            getParagraphs: function(e) {
                var e = e.find("p"),
                    r = [".vc_ui-help-block"];
                return e = (e = (e = e.filter(function(e, t) {
                    var n = o(t);
                    return !r.some(function(e) {
                        return n.is(e)
                    })
                })).filter(function(e, t) {
                    return 0 < o(t).text().trim().length
                })).filter(function(e, t) {
                    return !(1 === o(t).contents().length && 1 === o(t).children("a").length)
                })
            },
            getSentences: function(e) {
                return e.match(/\(?[^\.\?\!]+[\.!\?]\)?/g) || []
            },
            hasConsecutiveSentences: function(e) {
                for (var t = this.getSentences(e), n = 1, r = 1; r < t.length; r++)
                    if (t[r].split(" ")[0] === t[r - 1].split(" ")[0]) {
                        if (3 <= ++n) return {
                            consecutiveCount: n,
                            state: !0
                        }
            ...
            getPassiveVoicePercentage: function(e) {
                var n, r = 0,
                    i = 0;
                return e.length && (n = this, e.each(function(e, t) {
                    t = n.getSentences(o(t).text());
                    r += t.length, t.forEach(function(e) {
                        n.hasPassiveVoice(e) && i++
                    })
                })), (r ? i / r * 100 : 0).toFixed(2)
            },
            hasPassiveVoice: function(e) {
                return /\b(am|are|is|was|were|been|being)\s+[^.!?]*\b(by)\b/.test(e)
            },
            getWordsCount: function(e) {
                e = e.split(/\s/g);
                return (e = (e = e.reduce(function(e, t) {
                    t = t.replace(new RegExp("([ \\–\\-\\(\\)_\\[\\]’‘“”〝〞〟‟„\"'.?!:;,¿¡«»‹›—×+&۔؟،؛。｡！‼？⁇⁉⁈‥…・ー、〃〄〆〇〈〉《》「」『』【】〒〓〔〕〖〗〘〙〚〛〜〝〞〟〠〶〼〽｛｝｜～｟｠｢｣､［］･￥＄％＠＆＇（）＊／：；＜＞＼\\<>])", "g"), " $1 ");
                    return e.concat(t.split(" "))
                }, [])).filter(function(e) {
                    return "" !== e.trim()
                })).length
            },
            getTextSectionCount: function(e) {
                var e = (new DOMParser).parseFromString(e, "text/html").body.childNodes,
                    r = [];
                return e.forEach(function(e) {
                    var t, n;
                    e.nodeType === Node.ELEMENT_NODE && (t = (e = e).querySelectorAll("p"), n = 0, e = e.querySelectorAll("h1, h2, h3, h4, h5, h6").length, t.forEach(function(e) {
                        return n += (e.textContent || "").trim().split(/\s+/).length
                    }), t = {
                        wordCount: n,
                        subheadingCount: e
                    }, r.push(t))
...
window.vc || (window.vc = {}),
    function(n) {
        var e = Backbone.Model.extend({
            ...
            setResults: function(e, t, s) {
                var i, r, a = this.get(s);
                "focus-keyphrase" === t && (t = "keyphrase", e) && e !== this.get(s).keyphrase && (i = this, r = {
                    ...
                    e.success && (a.isUsedKeyphrase = e.data, i.set(s, a), i.trigger("formData", "change", a))
                }).fail(function(e) {
                    console.error("Failed to get the previously used keyphrase response: " + e)
                })), a[t] = e, this.set(s, a), "formData" === s && this.trigger("formData", "change", a)
            },
            updateResult: function(e, t, s) {
                var i = {
                        state: e,
                        title: t,
                        description: s
                    },
                    e = this.get("results").slice(),
                    t = e.findIndex(function(e) {
                        return e.title === i.title
                    }); - 1 !== t ? (e[t] = i, this.trigger("resultChanged", "update", i)) : (e.push(i), this.trigger("resultChanged", "add", i)), this.set("results", e)
            },
            resetResult: function(t) {
                var e = this.get("results").filter(function(e) {
                    return e.title !== t
                });
                this.set("results", e)
            }
        });
        vc.seo_storage = new e
    }(window.jQuery);
window.vc || (window.vc = {}),
    function(a) {
        var i = "results",
        ...
        vc.seo_checks = {
            ...
            analyzeContent: function(e) {
                this.$wpbContentWrapper = e;
                var t, e = this.$wpbContentWrapper.find(">div:not(#vc_no-content-helper)"),
                    n = e.find("p"),
                    o = e.find("img"),
                    s = vc.seo_storage.get("formData"),
                    c = {
                        content: e.length,
                        text: n.length,
                        images: o.length,
                ...
                for (t in h) h[t] && (h[t].conditions.every(function(e) {
                    return c[e]
                }) ? this[h[t].checkMethod](h[t].title) : vc.seo_storage.resetResult(h[t].title))
            },
            checkTitleWidth: function(e) {
                var t = "problems",
                    n = i18nLocale.seoTitleWidthTooLong,
                    o = r.measureTextWidth(vc.seo_storage.get("formData").title);
                o ? o < 600 && (t = "success", n = i18nLocale.goodJob) : n = i18nLocale.seoTitleEmpty, vc.seo_storage.updateResult(t, e, n, i)
            },
            checkFocusKeyphrase: function(e) {
                var t = "problems",
                    n = i18nLocale.noFocusKeyword;
                vc.seo_storage.get("formData").keyphrase && (t = "success", n = i18nLocale.goodJob), vc.seo_storage.updateResult(t, e, n, i)
            },
            checkDescriptionLength: function(e) {
                var t = "problems",
                    n = "";
                vc.seo_storage.get("formData").description.length ? vc.seo_storage.get("formData").description.length < 120 ? (t = "warnings", n = i18nLocale.seoDescriptionTooShort) : 120 < vc.seo_storage.get("formData").description.length && vc.seo_storage.get("formData").description.length <= 156 ? (t = "success", n = i18nLocale.wellDone) : 156 < vc.seo_storage.get("formData").description.length && (t = "warnings", n = i18nLocale.seoDescriptionTooLong) : n = i18nLocale.seoDescriptionEmpty, vc.seo_storage.updateResult(t, e, n, i)
            },
            checkKeyphraseInTitle: function(e) {
                var t = "problems",
                    n = i18nLocale.keyphraseInTitleEmpty.replace("%1$s", vc.seo_storage.get("formData").keyphrase),
                    o = vc.seo_storage.get("formData").title.toLowerCase(),
                    s = vc.seo_storage.get("formData").keyphrase.trim().toLowerCase(),
                    c = r.findKeyphrase(vc.seo_storage.get("formData").title, vc.seo_storage.get("formData").keyphrase),
                    o = 0 === o.indexOf(s);
                c.found && (n = o ? (t = "success", i18nLocale.goodJob) : (t = "warnings", i18nLocale.keyphraseInTitleWarn)), vc.seo_storage.updateResult(t, e, n, i)
            },
            checkKeyphraseInDescription: function(e) {
                var t = "problems",
                    n = i18nLocale.keyphraseInDescriptionEmpty;
                r.findKeyphrase(vc.seo_storage.get("formData").description, vc.seo_storage.get("formData").keyphrase).found && (t = "success", n = i18nLocale.keyphraseInDescriptionSuccess), vc.seo_storage.updateResult(t, e, n, i)
            },
            checkKeyphraseInSlug: function(e) {
                var t = "warnings",
                    n = i18nLocale.keyphraseInSlugProblem;
                r.findKeyphraseInSlug(vc.seo_storage.get("formData").slug, vc.seo_storage.get("formData").keyphrase).found && (t = "success", n = i18nLocale.greatWork), vc.seo_storage.updateResult(t, e, n, i)
            },
            checkKeyphraseInImages: function(e) {
                var t = "success",
                    n = "",
                    o = r.findKeyphraseInAltTag(this.images, vc.seo_storage.get("formData").keyphrase),
                    s = o.percentage,
                    o = o.imagesWithKeyphrase,
                    n = 4 < this.images.length ? 30 <= s && s <= 70 ? i18nLocale.goodJob : (70 < s ? (t = "warnings", i18nLocale.imageKeyphraseTooMuch) : (t = "warnings", i18nLocale.imageKeyphraseNotEnough)).replace("%1$s", this.images.length).replace("%2$s", o) : 0 < o ? i18nLocale.goodJob : (t = "warnings", i18nLocale.imageKeyphraseMissing);
                vc.seo_storage.updateResult(t, e, n, i)
            },
            checkKeyphraseDensity: function(e) {
                var t = "success",
                    n = "",
                    o = r.findKeyphraseDensity(this.textContent, vc.seo_storage.get("formData").keyphrase),
                    s = o.keyphraseOccurrences,
                    c = o.advisedMinOccurrences,
                    o = o.advisedMaxOccurrences,
                    n = s.length < c ? (t = "problems", i18nLocale.keyphraseDensityNotEnough.replace("%1$s", s.length).replace("%2$s", c)) : s.length >= c && s.length <= o ? i18nLocale.keyphraseDensitySuccess.replace("%1$s", s.length) : (t = "problems", i18nLocale.keyphraseDensityTooMuch.replace("%1$s", s.length).replace("%2$s", o));
                vc.seo_storage.updateResult(t, e, n, i)
            },
            checkInboundLinks: function(e) {
                var n = [],
                    t = i18nLocale.goodJob,
                    o = i18nLocale.noInternalLinks,
                    s = this.$wpbContentWrapper.find(">div:not(#vc_no-content-helper) a:not([class*='vc_control'])"),
                    c = "success";
                a.each(s, function(e, t) {
                    window.location.host === t.host && n.push(t)
                }), n.length || (c = "problems", t = o), vc.seo_storage.updateResult(c, e, t, i)
            },
            checkOutboundLinks: function(e) {
                var n = [],
                    t = i18nLocale.goodJob,
                    o = i18nLocale.noOutboundLinks,
                    s = this.$wpbContentWrapper.find(">div:not(#vc_no-content-helper) a:not([class*='vc_control'])"),
                    c = "success";
                a.each(s, function(e, t) {
                    window.location.host !== t.host && n.push(t)
            ...
            checkImages: function(e) {
                var t = "problems",
                    n = i18nLocale.noImages,
                    o = this.$wpbContentWrapper.find(">div:not(#vc_no-content-helper) img");
                (this.images = o).length && (t = "success", n = i18nLocale.goodJob), vc.seo_storage.updateResult(t, e, n, i)
            },
            checkPostTextLength: function(e) {
                var t = "problems",
                    n = i18nLocale.textLengthLess,
                    o = this.$wpbContentWrapper.html(),
                    s = r.getTextContent(o),
                    s = (this.textContent = s).split(/\s+/).length;
                (s = 1 === s && "" === r.getTextContent(o).split(/\s+/)[0] ? 0 : s) < 200 ? n = n.replace("%1$s", s).replace("%2$s", "far below") : 200 <= s && s < 250 ? n = n.replace("%1$s", s).replace("%2$s", "below") : 250 <= s && s < 300 ? (n = n.replace("%1$s", s).replace("%2$s", "slightly below"), t = "warnings") : 300 <= s && (n = window.sprintf(i18nLocale.textLengthSuccess, s), t = "success"), vc.seo_storage.updateResult(t, e, n, i)
            },
            checkKeyphraseInIntroduction: function(e) {
                var t = "problems",
                    n = i18nLocale.keyphraseInIntroductionEmpty,
                    o = r.getParagraphs(this.$wpbContentWrapper).first().text();
                r.findKeyphrase(o, vc.seo_storage.get("formData").keyphrase).found && (t = "success", n = i18nLocale.wellDone), vc.seo_storage.updateResult(t, e, n, i)
            },
            checkPassiveVoicePercentage: function(e) {
                ...
                t < 10 && (n = "success", o = i18nLocale.passiveVoiceSuccess), vc.seo_storage.updateResult(n, e, o, i)
            },
            checkForConsecutiveSentences: function(e) {
                var t = r.hasConsecutiveSentences(this.textContent),
                    n = t.state ? "problems" : "success",
                    o = i18nLocale.consecutiveSentencesSuccess;
                t.state && (o = i18nLocale.consecutiveSentencesFail.replace("%1$s", t.consecutiveCount)), vc.seo_storage.updateResult(n, e, o, i)
            },
            checkParagraphLength: function(e) {
                var t = "success",
                    n = i18nLocale.paragraphLengthSuccess,
                    o = r.getParagraphs(this.$wpbContentWrapper),
                    s = 0;
                o.each(function(e, t) {
                    t = a(t).text();
                    150 < r.getWordsCount(t) && s++
                }), 0 < s && (n = window.sprintf(i18nLocale.paragraphLengthError, s), t = "problems"), vc.seo_storage.updateResult(t, e, n, i)
            },
            checkSentenceLength: function(e) {
                var t = "success",
                    n = i18nLocale.great,
                    o = r.getParagraphs(this.$wpbContentWrapper),
                    s = 0,
                    c = 0,
                    o = (o.each(function(e, t) {
                        t = r.getSentences(a(t).text());
                        s += t.length, t.forEach(function(e) {
                            20 < r.getWordsCount(e) && c++
                        })
                    }), c / s * 100);
                1 !== s && 25 < o && (n = window.sprintf(i18nLocale.sentenceLengthError, o.toFixed()), t = "problems"), vc.seo_storage.updateResult(t, e, n, i)
            },
            checkSubheadingDistribution: function(e) {
                var t = this.$wpbContentWrapper.html(),
                    t = r.getTextSectionCount(t),
                    n = "success",
                    o = i18nLocale.goodJob,
                    s = t.filter(function(e) {
                        return !e.subheadingCount && 300 < e.wordCount
                    }),
                    t = t.filter(function(e) {
                        return 1 === e.subheadingCount && 300 < e.wordCount
                    });
                s.length ? (n = "problems", o = i18nLocale.subheadingDistributionFail) : t.length && (n = "warnings", o = i18nLocale.subheadingDistributionWarn.replace("%s", t.length)), vc.seo_storage.updateResult(n, e, o, i)
            },
            checkPreviouslyUsedKeyphrase: function(e) {
                var t = "success",
                    n = i18nLocale.previouslyUsedKeyphraseSuccess;
                vc.seo_storage.get("formData").isUsedKeyphrase && (t = "warnings", n = i18nLocale.previouslyUsedKeyphraseWarn), vc.seo_storage.updateResult(t, e, n, i)
            }
        }
    }(window.jQuery);
! function(l) {
    _.isUndefined(window.vc) && (window.vc = {}), l.ajaxSetup({
        ...
        fixElContainment: function() {
            ...
            var e = [20 - this.$el.width(), 0, this.$body.width() - 20, this.$body.height() - 30],
                t = this.$el.position(),
                i = {};
            t.left < e[0] && (i.left = e[0]), t.top < 0 && (i.top = 0), t.left > e[2] && (i.left = e[2]), t.top > e[3] && (i.top = e[3]), this.$el.css(i), this.trigger("fixElContainment"), this.setSize()
        },
        ...
        initialize: function() {
            vc.$custom_css = l("#vc_post-custom-css"), vc.$custom_js_header = l("#vc_post-custom-js-header"), vc.$custom_js_footer = l("#vc_post-custom-js-footer"), this.saved_css_data = vc.$custom_css.val(), this.saved_js_header_data = vc.$custom_js_header.val(), this.saved_js_footer_data = vc.$custom_js_footer.val(), this.saved_title = vc.title, this.initEditor(), this.$body = l("body"), _.bindAll(this, "setSize", "fixElContainment"), this.on("show", this.setSize, this), this.on("setSize", this.setResize, this), this.on("render", this.resetMinimize, this), this.on("afterRender", function() {
        ...
        setSize: function() {
            this.is_css && this.editor_css.setSize(), this.is_js_header && this.editor_js_header.setSize(), this.is_js_footer && this.editor_js_footer.setSize(), this.trigger("setSize")
        },
        save: function() {
            var e;
...
! function(a) {
    window.vc.HelperPanelSettingsPostCustomLayout = {
        ...
        changePostCustomLayout: function(t) {
            var e;
            t && t.preventDefault && (t.preventDefault(), e = (t = a(t.currentTarget)).attr("data-post-custom-layout"), t.addClass("vc-active-post-custom-layout"), t.siblings().removeClass("vc-active-post-custom-layout"), a("input[name=vc_post_custom_layout]").val(e))
        }
    }
}(window.jQuery);
! function(t) {
    ...
    window.vc.EditElementPanelView = vc.PanelView.vcExtendUI(vc.HelperAjax).vcExtendUI(vc.ExtendPresets).vcExtendUI(vc.ExtendTemplates).vcExtendUI(vc.HelperPrompts).extend({
        ...
        buildParamsContent: function(e) {
            var t, n, i = this.model.get("id"),
                ...
                s = 0,
                 /* nectar addition - nectarAfterRenderCbBindThis in callback */
                nectarAfterRenderCbBindThis = nectarAfterRenderCb.bind(this),
                c = function() {
                    !window.wpb_edit_form_loaded && s < 10 ? (s++, setTimeout(c, 100)) : (a.$content.removeAttr("data-vc-param-initialized"), a.active_tab_index = 0, a.tabsInit = !1, a.panelInit = !1, a.dependent_elements = {}, a.requiredParamsInitialized = !1, a.$content.find("[data-vc-param-initialized]").removeAttr("data-vc-param-initialized"), n.removeClass("visually-hidden"), a.$content.find(".vc_ui-wp-spinner").remove(), a.init(), a.$content.parent().scrollTop(1).scrollTop(0), a.$content.removeClass("vc_properties-list-init"), a.$el.trigger("vcPanel.shown"), a.trigger("afterRender"), nectarAfterRenderCbBindThis() )
                };
            window.setTimeout(c, 800);

            /* nectar addition */
            function nectarAfterRenderCb() {
                jQuery('[data-vc-shortcode="text-with-icon"] .icon.dropdown').chosen({
                ...
                jQuery('.wpb-textinput.background_color, .gallery_widget_attached_images_ids').change(function(){
                 ...
                 function verticallyCenterColumns() {
                      ...
                      if(jQuery('select[name="type"]').val() == 'full_width_content' && $using_nectar_fspr) {

                         jQuery('select[name="full_screen_row_position"] .full_height').show();

                      } else if(jQuery('select[name="type"]').val() == 'full_width_background' && $using_nectar_fspr) {
                     ...
                     if($using_nectar_fspr && jQuery('select#_nectar_full_screen_rows_row_bg_animation').val() == 'ken_burns')
                 ...
                 if(jQuery('[data-vc-shortcode="nectar_image_with_hotspots"]').length > 0) { 
                     ...
                     ////remove 
                     jQuery('body').on('click','.hotspot-content a.delete',function(e){
...
window.vc || (window.vc = {}),
    function(c) {
        ...
        window.vc.PostSettingsSeoUIPanel = vc.PostSettingsSeoUIPanelView.vcExtendUI(vc.HelperPanelViewHeaderFooter).vcExtendUI(vc.HelperPanelViewResizable).vcExtendUI(vc.HelperPanelViewDraggable).extend({
            ...
            show: function() {
                var e;
                this.$el.hasClass("vc_active") || (this.$el.addClass("vc_active"), this.draggable || this.initDraggable(), this.fixElContainment(), this.trigger("show"), (e = this.$el.find(".vc_panel-tab")).length && (this.$tabs = e))
            },
            changeTab: function(e) {
                e.preventDefault();
                e = c(e.currentTarget).parent(), c('[data-vc-ui-element="panel-add-element-tab"].vc_active').removeClass("vc_active"), e.addClass("vc_active"), this.$tabs.filter(".vc_active").removeClass("vc_active"), e = e.data("tabIndex");
                this.$tabs.filter('[data-tab-index="' + e + '"]').addClass("vc_active")
            },
            removeImage: function(e) {
                var t = c(e.currentTarget),
                    i = t.closest(".edit_form_line"),
                    a = i.attr("data-social-net-preview-slug"),
                    a = c("#" + a);
                a.find(".wpb-social-placeholder-image").show(), a.find("img").attr("src", ""), i.find(".gallery_widget_attached_images_ids").val(""), e && e.preventDefault && e.preventDefault(), t.parent().remove()
            },
            updateImagePreview: function(e) {
                var t, e = c(e.currentTarget).closest(".edit_form_line"),
                    i = e.find(".inner img").attr("src"),
                    e = e.attr("data-social-net-preview-slug");
                e && i && (i = i.replace("-150x150", ""), (t = (e = c("#" + e)).find("img")).attr("src", i), t.show(), e.find(".wpb-social-placeholder-image").hide())
            },
            ...
            updateDescriptionPreview: function(e) {
                var e = c(e.currentTarget),
                    t = e.closest(".vc_seo-social-block"),
                    e = e.val();
                t.find(".wpb-social-net-preview .vc_social-description").text(e), t.find(".vc_social-description-counter").text(e.length)
            },
            focusTarget: function(e) {
                e = c(e.currentTarget).data("focus");
                c("#" + e).focus()
            },
            changePreviewMode: function(e) {
                var t = this.$el.find(".page-preview");
                "mobile" === c(e.currentTarget).val() ? t.removeClass("desktop-view") : t.addClass("desktop-view")
            },
            createSlug: function(e) {
                e = e.toLowerCase();
                return e = (e = (e = e.replace(/\s+/g, "-")).replace(/[^a-zA-Z0-9\-]/g, "")).replace(/^[.,!?()[]{}<>:;]+|[.,!?()[]{}<>:;]+$/g, "")
            },
            updateGeneralPreviewText: function(e) {
                var t = c(e.currentTarget).val(),
                    e = ("vc_seo-slug-field" === c(e.currentTarget).attr("id") && (t = this.createSlug(t)), c(e.currentTarget).data("preview")),
                    e = this.$el.find("#" + e);
                e && e.text(t)
            },
            handleInputChange: function(e) {
                var t = e.target.value.trim();
                vc.seo_storage.setResults(t, e.target.name, a)
            },
            setFormDataState: function() {
                this.$el.find("#vc_ui-seo-general").find('input[type="text"], textarea').each(function(e, t) {
                    var i = c(t).attr("name"),
                        t = c(t).val();
                    vc.seo_storage.setResults(t, i, a)
                }), this.$el.find("#vc_ui-seo-social").find('input[type="text"], textarea').each(function(e, t) {
                    var i = c(t).attr("name"),
                        t = c(t).val();
                    vc.seo_storage.setResults(t, i, a)
                })
...
window.vc || (window.vc = {}),
    function(s) {
        vc.SeoAnalysisView = Backbone.View.extend({
            ...
            currentBadge: "",
            initialize: function() {
                this.$wpbContentWrapper = this.getContentWrapper(), this.$navbarIcon = s("#vc_seo-button"), vc.seo_utils.createMeasurementElement(), vc.seo_checks.analyzeContent(this.$wpbContentWrapper), this.render(), this.setIconBadge(), this.setEvents()
            },
            render: function() {
                vc.seo_checks.analyzeContent(this.$wpbContentWrapper);
                var e = this.getNotificationsHtml();
                this.$el.html(e), this.setIconBadge()
            },
            setEvents: function() {
            ...
            getNotificationsHtml: function() {
                var t = this,
                    ...
                    o = ["problems", "warnings", "success"];
                return Object.keys(n).sort(function(e, t) {
                    return o.indexOf(e) - o.indexOf(t)
                }).forEach(function(e) {
                    n[e].length && (e = t.getResultsHtml(e, n[e]), s.push(e))
                }), s
            },
            setIconBadge: function() {
                ...
                var t = "success",
                    n = this.model.get("results");
                e("problems") ? t = "problems" : e("warnings") && (t = "warnings"), this.$navbarIcon.removeClass(this.currentBadge), this.currentBadge = "vc_ui-badge--" + t, this.$navbarIcon.addClass(this.currentBadge)
            },
            getResultsHtml: function(e, t) {
                var e = s('<div class="vc_ui-seo-results-section"><strong>' + window.i18nLocale[e] + '</strong><ul class="vc_ui-seo-results-list"></ul></div>'),
                    n = e.find("ul");
                return s.each(t, function(e, t) {
                    t = s('<li class="vc_ui-seo-results-list-item vc_ui-seo-results-list-item--' + t.state + '">' + t.title + ": " + t.description + "</li>");
                    n.append(t)
                }), e
            },
            getContentWrapper: function() {
                // nectar addition
                return "admin_frontend_editor" === window.vc_mode ? vc.$frame.contents().find(".container-wrap > .main-content") : jQuery("#wpbakery_content")
                // nectar addition end
            }
...
_.isUndefined(window.vc) && (window.vc = {}), _.extend(vc, {
    ...
    function(l) {
        vc.map = {}, vc.setFrameSize = function(e) {
        ...
        }), vc.getMergedParams = function(c, r) {
            var s, d = vc.getDefaultsAndDependencyMap(c),
                l = {};
                ...
                if ("content" !== t) {
                    if (!_.isUndefined(s[t])) {
                        ...
                        var n, a = s[t].element,
                            o = r[a],
                            i = !1;
                        if ("string" == typeof o && (i = r[a].split(",").map(function(e) {
                                return e.trim()
                            }).filter(function(e) {
                                return e
                            })), a = _.isEmpty(o), n = _.omit(s[t], "element"), _.isBoolean(n.not_empty) && !0 === n.not_empty && a || _.isBoolean(n.is_empty) && !0 === n.is_empty && !a || n.value && !_.intersection(_.isArray(n.value) ? n.value : [n.value], _.isArray(o) ? o : [o]).length && i && n.value && !_.intersection(_.isArray(n.value) ? n.value : [n.value], _.isArray(i) ? i : [i]).length || n.value_not_equal_to && _.intersection(_.isArray(n.value_not_equal_to) ? n.value_not_equal_to : [n.value_not_equal_to], _.isArray(o) ? o : [o]).length && i && n.value_not_equal_to && _.intersection(_.isArray(n.value_not_equal_to) ? n.value_not_equal_to : [n.value_not_equal_to], _.isArray(i) ? i : [i]).length) return void(s[t].failed = !0)
                    }
                    a = vc.getParamSettings(c, t), (_.isUndefined(a) || !_.isUndefined(d.defaults[t]) && d.defaults[t] !== e || _.isUndefined(d.defaults[t]) && "" !== e || !_.isUndefined(a.save_always) && !0 === a.save_always) && (l[t] = e)
                }
            }), l
            ...
            var o, i, c, r;
            return vc.clone_index /= 10, o = _.isBoolean(a) && !0 === a ? e.get("order") : parseFloat(e.get("order")) + vc.clone_index, i = _.extend({}, e.get("params")), n = {
                shortcode: c = e.get("shortcode"),
                parent_id: n,
                order: o,
                cloned: !0,
                cloned_from: e.toJSON(),
                params: i
            }, vc["cloneMethod_" + c] && (n = vc["cloneMethod_" + c](n, e)), _.isBoolean(a) && !0 === a || (n.place_after_id = e.get("id")), t.create(n), r = t.last(), _.each(vc.shortcodes.where({
                parent_id: e.get("id")
            }), function(e) {
            ...
            checkControlsPosition: function() {
                var e, t;
                this.$controls_buttons && (t = this.$el.height(), vc.$frame.height() < t) && (e = l(vc.frame_window).scrollTop(), this.$controls_buttons.offset().top, 40 < (e = e - this.$el.offset().top + vc.$frame.height() / 2) && e < t ? this.$controls_buttons.css("top", e) : t < e ? this.$controls_buttons.css("top", t - 40) : this.$controls_buttons.css("top", 40))
            },
            ...
            addControls: function() {
                var e = this.model.get("shortcode"),
                    ...
                    i = vc.shortcodes.get(this.model.get("parent_id")),
                    e = {
                        name: vc.getMapped(e).name,
                        tag: e,
                        parent_name: i ? vc.getMapped(i.get("shortcode")).name : "",
                        parent_tag: i ? i.get("shortcode") : "",
                        can_edit: a,
                        can_all: n,
                        moveAccess: o,
                    ...
                    i = vc.template(_.unescape(t), _.extend({}, vc.templateOptions.custom, {
                        evaluate: /\{#([\s\S]+?)#}/g
                    }));
                this.$controls = l(i(e).trim()).addClass("vc_controls"), this.$controls.appendTo(this.$el), this.$controls_buttons = this.$controls.find("> :first")
            },
            content: function() {
            ...
            _getDefaultTemplate: function() {
                var e;
                return !_.isUndefined(this.default_controls_template) && this.default_controls_template || (this.default_controls_template = l("<div><div>").html(l("#vc_controls-template-default").html()), e = this.$el.data("shortcode-controls"), _.isUndefined(e)) || l(".vc_control-btn[data-control]", this.default_controls_template).each(function() {
                    -1 == l.inArray(l(this).data("control"), e) && l(this).remove()
            ...
            openTemplatesWindow: function(e) {
                vc.templates_panel_view.once("show", function() {
                    l('[data-vc-ui-element-target="[data-tab=default_templates]"]').click()
                }), vc.app.openTemplatesWindow.call(this, e)
            },
            updateKeyPress: function(e) {
                if (13 === e.which) return e && e.preventDefault && e.preventDefault(), vc.$title.attr("contenteditable", !1), l(".entry-content").trigger("click"), !1
            },
            loadDefaultTemplate: function(e) {
                e && e.preventDefault && e.preventDefault(), vc.templates_panel_view.loadTemplate(e), l("#vc_no-content-helper").remove()
            },
            setTitle: function(e) {
                vc.$title.length && vc.$title.text(e || vc.no_title_placeholder), vc.title = e, vc.update_title = !0
            },
            initialize: function() {
                vc.frame_window = vc.$frame.get(0).contentWindow, l(vc.frame_window.document.body).on("paste", this.handleEditorPaste)
            },
            ...
            setActiveHover: function(e) {
                this.$hover_element && this.$hover_element.removeClass("vc_hover"), this.$hover_element = l(e.currentTarget).addClass("vc_hover"), e.stopPropagation()
            },
            ...
            render: function() {
                return !1 !== vc_user_access().getState("post_settings") && (vc.$title = l(vc.$frame.get(0).contentWindow.document).find('h1:contains("' + (vc.title || vc.no_title_placeholder).replace(/"/g, '\\"') + '")'), vc.$title.on("click", function(e) {
                    e.preventDefault(), vc.post_settings_view.render().show()
                })), 
                // nectar addition - removing wpb-content-wrapper warning
                // jQuery(vc.$frame.get(0).contentWindow.document).find(".wpb-content-wrapper").length || window.vc.showMessage(window.i18nLocale.not_editable_post || "This post can not be edited with WPBakery since it is missing a WordPress default content area.", "error", "30000"), 
                this
            },
            ...
            changePostCustomLayout: function(e) {
                var t;
                e && e.preventDefault && (e.preventDefault(), t = (e = l(e.currentTarget)).hasClass("vc-active-post-custom-layout"), e = e.attr("href"), t || (window.location.href = e))
            }
            ...
            render: function() {
                return vc.updateSettingsBadge(), vc.$page = l(vc.$frame.get(0).contentWindow.document).find("#vc_inline-anchor").parent(), vc.$frame_body = l(vc.$frame.get(0).contentWindow.document).find("body").addClass("vc_editor"), this.setMode("compose"), this.$size_control = l("#vc_screen-size-control"), l(".vc_element-container", vc.frame_window.document).droppable({
                    accept: ".vc_element_button"
                }), l(window).on("resize", this.resizeWindow), _.defer(function() {
                    vc.events.trigger("app.render")
                }), this
            },
            cancel: function(e) {
                e && e.preventDefault && e.preventDefault(), window.location.href = l(e.currentTarget).data("url")
            },
            save: function(e) {
                e && e.preventDefault && e.preventDefault(), vc.builder.save(l(e.currentTarget).data("changeStatus"))
            },
            resizeFrame: function(e) {
                var t = l(e.currentTarget);
                if (e && e.preventDefault && e.preventDefault(), t.hasClass("active")) return !1;
                this.$size_control.find(".active").removeClass("active"), l("#vc_screen-size-current").attr("class", "vc_current-layout-icon " + t.attr("class")), this.current_size = t.data("size"), t.addClass("active"), vc.setFrameSize(this.current_size)
            },
            editCloned: function(e) {
                e && e.preventDefault && e.preventDefault(), e = l(e.currentTarget).data("modelId"), e = vc.shortcodes.get(e), vc.edit_element_block_view.render(e)
            },
            ...
            setMode: function(e) {
                var t = l("body").removeClass(this.mode + "-mode");
            ...
            saveRowOrder: function(e, t) {
                _.defer(function(e) {
                    var i, c, r = l(t.item.parent()),
                        s = r.find("> [data-tag=vc_row],> [data-tag=vc_section]"),
                        d = new vc.ShortcodesBuilder;
                    s.each(function(e, t) {
                        var n, a, o = l(this);
                        o.is(".droppable") ? (i = {}, c = {
                            width: "1/1"
                            ...
                            params: i,
                            order: e
                        }, 0 === e ? vc.activity = "prepend" : e + 1 !== s.length && (n.place_after_id = vc.$page.find("> [data-tag=vc_row]:eq(" + (e - 1) + ")").data("modelId")), d.create(n).create({
                            shortcode: "vc_column",
                            parent_id: d.lastID(),
                            params: c
                        }).render()) : (o = (n = vc.shortcodes.get(o.data("modelId"))).get("parent_id"), a = r.closest(".vc_element").data("modelId") || !1, n.save({
                            order: e,
                            parent_id: a
                        }, {
                            silent: !0
                        }), o !== a && (vc.builder.notifyParent(a), vc.builder.notifyParent(o)))
                    }), vc.setDataChanged()
                }, this)
            },
            saveElementOrder: function(e, t) {
                _.defer(function(e, t, n) {
                    var i, c;
                    _.isNull(n.sender) && (i = n.item.parent(), c = i.find("> [data-model-id]"), i.find("> [data-model-id]").each(function(e, t) {
                        var n, a = l(this),
                            o = !1;
                        a.is(".droppable") ? (n = vc.shortcodes.get(i.parents(".vc_element[data-tag]:first").data("modelId")), a.remove(), 0 === e ? o = !0 : e + 1 !== c.length && (o = i.find("> [data-tag]:eq(" + (e - 1) + ")").data("modelId")), n && vc.add_element_block_view.render(n, o)) : (a = (o = vc.shortcodes.get(a.data("modelId"))).get("parent_id"), n = i.parents(".vc_element[data-tag]:first").data("modelId"), o.save({
                            order: e,
                            parent_id: n
                        }, {
                            silent: !0
...
window.jQuery, _.isUndefined(window.vc) && (window.vc = {}), vc.addTemplateFilter(function(d) {
    var e = VCS4() + "-" + VCS4();
    ...
    window.vc.events.on("shortcodeView:updated", function(e) {
        ...
        holdActive: function(e) {
            ...
            this.hold_active = window.setTimeout(function() {
                t.hold_active && window.clearTimeout(t.hold_active), t.hold_active = !1, t.$el.removeClass("vc_hold-active")
            }, 700)
        },
        content: function() {
        ...
        addControls: function() {
             // nectar addition - missing from first declaration below in 7.5..
            var d = "";
            // nectar addition end 
            var e = this.model.get("shortcode"),
                t = r(this.controls_selector).html(),
                n = vc.shortcodes.get(this.model.get("parent_id")),
                n = (n && (s = vc.getMapped(n.get("shortcode")).name, d = n.get("shortcode")), vc_user_access().shortcodeAll(e)),
                c = vc_user_access().shortcodeEdit(e),
                o = vc_user_access().shortcodeAll(d),
                i = vc_user_access().shortcodeEdit(d),
                l = vc_user_access().partAccess("dragndrop"),
                e = {
                    name: vc.getMapped(e).name,
                    tag: e,
                    parent_name: s,
                    ...
                    switcherPrefix: o && n ? "" : "-disable-switcher"
                },
                s = vc.template(_.unescape(t), _.extend({}, vc.templateOptions.custom, {
                    evaluate: /\{#([\s\S]+?)#}/g
                })),
                d = "vc_controls";
            this.model.setting("as_parent") && this.model.setting("content_element") && (d += " vc_controls-parent"), this.$controls = r(s(e).trim()).addClass(d), this.$controls.appendTo(this.$el)
        },
        ...
        multi_edit: function(e) {
            var t, n = [];
            e && e.preventDefault && e.preventDefault(), (t = this.model.get("parent_id") ? vc.shortcodes.get(this.model.get("parent_id")) : t) ? (n.push(t), e = vc.shortcodes.where({
                parent_id: t.get("id")
            }), window.vc.multi_edit_element_block_view.render(n.concat(e), this.model.get("id"))) : window.vc.edit_element_block_view.render(this.model)
        },
...
! function(t) {
    window.InlineShortcodeViewContainerWithParent = window.InlineShortcodeViewContainer.extend({
        ...
        switchControls: function(e) {
            e && e.preventDefault && e.preventDefault(), vc.unsetHoldActive(), (e = t(e.currentTarget).parent()).addClass("vc_active"), (e = e.siblings(".vc_active")).removeClass("vc_active"), e.hasClass("vc_element") || window.setTimeout(this.holdActive, 500)
        }
    })
}(window.jQuery);
...
window.jQuery, window.vc.ttaSectionActivateOnClone = !1, window.InlineShortcodeView_vc_tta_toggle_section = window.InlineShortcodeView_vc_tta_section.extend({
    ...
    window.vc.cloneMethod_vc_tab = function(t, e) {
        ...
        buildNav: function() {
             ...
             this.$tabs.parent().find('> .vc_element[data-tag="tab"]').each(function(key) {
                 jQuery("li:eq(" + key + ")", $nav).attr("data-m-id", jQuery(this).data("model-id"))
             });
             ...
             if(this.$tabs.parent().is('[data-style="toggle_button"]')) {
                 ...
                 setTimeout(function(){
                     if ( that.$tabs.find('.toggle-button-inner').length > 0 ) {
                         ...
                         jQuery('<li class="toggle-button"><span class="toggle-button-inner nectar-color-'+color+' nectar-bg-'+color+'"><span class="circle"></span></span></li>')
                ...
                setTimeout(function(){
                  if(thatPointer.$el.find('.wpb_tabs_nav .active-tab').length > 0) {
                     thatPointer.$el.find('.wpb_tab').each(function(i){
                      if(jQuery(this).is('[data-tab-icon]') && jQuery(this).attr('data-tab-icon').length > 0) {
                         var $data_m_id = (jQuery(this).parent().is('[data-model-id]')) ? jQuery(this).parent().attr('data-model-id') : '';
                         jQuery(this).parents('.tabbed').addClass('using-icons');
                         thatPointer.$el.find('.wpb_tabs_nav > li[data-m-id="'+$data_m_id+'"] a i').remove();
                         thatPointer.$el.find('.wpb_tabs_nav > li[data-m-id="'+$data_m_id+'"] a').prepend('<i class="'+jQuery(this).attr("data-tab-icon")+'"></i>');
                      }
                    });
        ...
        cloneTabAfter: function(t) {
            /*nectar addition*/
            this.$tabs.parent().find("> .wpb_tabs_nav > div").remove(), this.buildTabs(t)
            /*nectar addition end*/
        },
        /*nectar addition*/
        ...
        placeElement: function(t, e) {
            var i = window.vc.shortcodes.get(t.data("modelId"));
            i && i.get("place_after_id") ? (t.insertAfter(window.vc.$page.find("[data-model-id=" + i.get("place_after_id") + "]")), i.unset("place_after_id")) : t.insertAfter(this.tabsControls()), this.changed()
        },
...
window.InlineShortcodeView_vc_accordion_tab = window.InlineShortcodeView_vc_tab.extend({
    ...
    destroy: function(e) {
        ...
        window.InlineShortcodeView_vc_accordion_tab.__super__.destroy.call(this, e), vc.shortcodes.where({
            parent_id: t
        }).length || vc.shortcodes.get(t).destroy()
    },
    allowAddControl: function() {
    ...
    window.InlineShortcodeView_clients = window.InlineShortcodeView_vc_accordion.extend({
        ...
        stopSorting: function() {
            this.$accordion.find("> .vc_element[data-tag]").each(function() {
                vc.shortcodes.get(jQuery(this).data("modelId")).save({
        ...
        updateNumericalIcons: function() {
          ...
          setTimeout(function(){
            $that.$el.find('> .nectar-icon-list .list-icon-holder[data-icon_type="numerical"]').each(function(i){
              jQuery(this).find('span').html(i+1);
            });
          },400);
        ...
        updated: function() {
            ...
            if(this.$el.find('.testimonial_slider[data-style="multiple_visible_minimal"]').length > 0) {
              ...
              this.$el.find('blockquote').each(function() {
                  ...
                  var $testimonialName = jQuery(this).find('.testimonial-name').detach();
                  var $testimonialTitle = jQuery(this).find('.title').detach();
                  var $testimonialQuote = jQuery(this).find('p').detach();
                  var $testimonialImage = (jQuery(this).find('.image-icon').length > 0) ? jQuery(this).find('.image-icon').detach() : '';
                  var $testimonialStarRating = (jQuery(this).find('.star-rating-wrap').length > 0) ? jQuery(this).find('.star-rating-wrap').detach() : '';
                  ...
                  jQuery(this).empty();
                  jQuery(this).append('<div class="inner" />');
                  jQuery(this).find('.inner').append($testimonialImage);
                  jQuery(this).find('.inner').append('<span class="wrap" />');
                  jQuery(this).find('.wrap').append($testimonialName);
                  jQuery(this).find('.wrap').append($testimonialTitle);
                  jQuery(this).find('.inner').append($testimonialQuote);
                  jQuery(this).find('.inner').append($testimonialStarRating);
            ...
            this.$el.find('blockquote').each(function() {
                ...
                jQuery(this).empty();
                jQuery(this).append($testimonialImage);
                jQuery(this).append($testimonialQuote);
                jQuery(this).append($testimonialName);
                jQuery(this).append($testimonialTitle);
...
! function(i) {
    ...
    t.prototype = {
        ...
        getPointer: function(t) {
            // nectar addition - fixing broken pointer JS error
            if (!this.pointers[t]) {
...
! function(e) {
    e(function() {
        var o, n, d;
        window.vc && window.vc.events && (o = e("#vc_navbar-undo"), n = e("#vc_navbar-redo"), d = function(n) {
            for (vc.createOverlaySpinner(); vc.shortcodes.models.length;) vc.shortcodes.models[0].destroy();
            vc.shortcodes.reset([], {
                silent: !0
            }), _.delay(function() {
                var o = n.length ? vc.builder.parse([], n) : [];
            ...
            o.attr("disabled", !window.vc.undoRedoApi.canUndo()), n.attr("disabled", !window.vc.undoRedoApi.canRedo())
        }), o.on("click.vc-undo", function(o) {
            e(this).is("[disabled]") || window.vc.undoRedoApi.isLocked() ? o && o.preventDefault && o.preventDefault() : (window.vc.undoRedoApi.lock(), o = window.vc.undoRedoApi.undo(), d(o))
        }), n.on("click.vc-redo", function(o) {
            e(this).is("[disabled]") || window.vc.undoRedoApi.isLocked() ? o && o.preventDefault && o.preventDefault() : (window.vc.undoRedoApi.lock(), o = window.vc.undoRedoApi.redo(), d(o))
        }))
    })
}(window.jQuery);
window.vc || (window.vc = {}),
    function() {
        ...
        var a = function(o, e, t) {
                var r, c, n, i, a, d, s, l, p, h, v, S = !0;
                return o ? (e = (o = m(o, e, t)).isModelRow, r = o.isModelSection, c = o.isModelColumn, n = o.isModelColumnInner, i = o.isModelRowInner, a = o.isModelTtaSection, d = o.isTopShortcodeRow, s = o.isTopShortcodeRowInner, l = o.isTopShortcodeSection, p = o.containerPreventsShortcode, h = o.isShortcodeContainer, v = o.shortcodeRejectsAsChild, o = o.containerRejectsAsParent, S = h && (p && !(a && s) || !p && a && d || e && !(d || l) || i && !s || c && d || n && (s || d)) || !h && (e || i) || (v || o) && !(l && (r || e))) : "vc_row" === t[0].shortcode && (S = !1), S
            },
            d = function(o, e, t, r) {
                var c, n, i, a, d, s = Object.assign({}, e);
                return o && (t = (e = m(o, e, t)).isModelRow, c = e.isModelRowInner, n = e.isModelSection, i = e.isTopShortcodeRow, a = e.isTopShortcodeRowInner, d = e.isTopShortcodeSection, e = e.isModelContainer, s.params.tab_id && (s.params.tab_id = Date.now() + "-" + vc_guid()), c && a || t && i || !o.get("parent_id") && (!n || !i) ? (r && (s.place_after_id = o.get("id")), s.parent_id = o.get("parent_id")) : e && !t && (s.parent_id = o.get("id")), (t || c) && (i || a) || (t || n) && d) && (s.order = parseFloat(o.get("order")) + vc.clone_index), r ? (r.create(s), r.last()) : vc.shortcodes.create(s)
            },
            m = function(o, e, t) {
...
! function(t) {
    var c = t("#vc_ui-helper-modal-ai"),
        e = t("#wpwrap"),
        a = c.find('[data-vc-ui-element="button-save"]');

    function l(e) {
        window.vc.showMessage(e, "error", 1e4, "#vc_ui-helper-modal-ai .vc_ui-panel-window-inner")
    }

    function r(e) {
        t(e.target).closest('[data-vc-ui-element="button-close"]').length && (c.removeClass("vc_active"), c.off("click", r), c.removeData(), c.find(" .vc_ui-panel-content-container").addClass("vc_ui-hidden"), c.find(" .vc_ui-helper-modal-ai-placeholder").addClass("vc_ui-hidden"), a.hide())
    }
    e.on("click", ".vc_ui-icon-ai", function(e) {
        var e = t(e.currentTarget),
            a = e.closest(".vc_shortcode-param"),
            i = null,
            n = e.data();
        a.length && (i = a.data());
        var d = n.wpbAiElementType || "textarea",
            o = n.fieldId || d;
        c.find(".vc_ui-helper-modal-ai-preloader").length || c.find(".vc_ui-post-settings-header-container").after('<div class="vc_ui-helper-modal-ai-preloader"><div class="vc_ui-wp-spinner vc_ui-wp-spinner-dark vc_ui-wp-spinner-lg"></div></div>');
        (function(e, a) {
            e = {
            ...
            t.ajax({
                ...
                !0 === e.success ? (void 0 === window.vc.ai_modal_view ? window.vc.ai_modal_view = new vc.AiFormView({
                    el: "#vc_ui-helper-modal-ai",
                    data: e.data
                }) : window.vc.ai_modal_view.render(e.data), c.find(" .vc_ui-panel-content-container").scrollTop(0), c.find(".vc_ui-helper-modal-ai-preloader").remove(), c.find(" .vc_ui-panel-content-container").removeClass("vc_ui-hidden")) : e && e.data && e.data[0] && e.data[0].code && e.data[0].message ? (console.error(e.data[0].message), l(e.data[0].message)) : (console.error(window.i18nLocale.ai_response_error), l(window.i18nLocale.ai_response_error))
            }).fail(function(e) {
                console.error(window.i18nLocale.ai_response_error), _this.resetButton(), l(window.i18nLocale.ai_response_error)
            })
        })(d, o), i ? (d = a.find("." + i.param_type), c.data("element", d), t.each(i, function(e, a) {
            c.data(e, a)
        })) : n.fieldId && (o = e.closest(".edit_form_line"), a = e.closest(".vc_ui-settings-text-wrapper"), d = e.closest("#postdivrich"), i = null, o.length ? i = o.find("#" + n.fieldId) : a.length ? i = a.siblings("#" + n.fieldId) : d.length && (i = d.find("#" + n.fieldId)), c.data("fieldId", n.fieldId), c.data("element", i));
        c.addClass("vc_active"), c.on("click", r)
    })
}(window.jQuery);
! function(i) {
    window.vc.AiFormView = Backbone.View.extend({
        ...
        maxPromptLength: 2e3,
        initialize: function(e) {
            this.toggleModalPromoClass(e.data.type), this.$el.find(".vc_ui-helper-modal-ai-preloader").after(e.data.content), this.setFormElements(), i(".edit-form-info").initializeTooltips()
        },
        render: function(e) {
            return this.timerInterval && this.clearTimer(), this.toggleModalPromoClass(e.type), this.$form.after(e.content), this.$form.remove(), this.setFormElements(), this
        },
        ...
        generateContent: function(e) {
            ...
            this.isGenerating = !0, this.$generate_placeholder.removeClass("vc_ui-hidden"), this.timerInterval = setInterval(this.updateTimer.bind(this), 1e3), i.ajax({
                type: "POST",
                url: window.ajaxurl,
                timeout: 2e4,
                data: e
            }).done(function(e) {
                if (!r.isGenerating) return !1;
                !0 === e.success ? (r.$generated_content.val(e.data), r.resetButton(!0), r.$insert_button.show()) : e && e.data && e.data[0] && e.data[0].code && e.data[0].message ? (console.error(e.data[0].code, e.data[0].message), r.resetButton(!1), e = e.data[0].message.replace(/\\/g, ""), r.showErrorMessage(e)) : (console.error(window.i18nLocale.ai_response_error), r.resetButton(!1), r.showErrorMessage(window.i18nLocale.ai_response_error))
            }).fail(function(e) {
                if (!r.isGenerating) return !1;
                if (e && !e.statusText) console.error(window.i18nLocale.ai_response_error), r.resetButton(!1), r.showErrorMessage(window.i18nLocale.ai_response_error);
                else if ("timeout" !== e.statusText) console.error(window.i18nLocale.ai_response_error), r.resetButton(!1), r.showErrorMessage(window.i18nLocale.ai_response_error);
                else
                    for (var i = {
                            ...
                            _vcnonce: window.vcAdminNonce
                        }, a = [], t = 1e4; t <= r.maxWaitingCacheInterval; t += 1e4) ! function(n) {
                        a.push(setTimeout(function() {
                            var e = r.$generated_content.val();
                            if (e)
                                for (var t = 0; t < a.length; t++) "stop_cache_timeouts" === e && r.$generated_content.val(""), clearTimeout(a[t]);
                            else r.processCachedRequest(r, i, n)
                        }, n))
                    }(t)
            })
        },
        processCachedRequest: function(t, e, n) {
            this.maxWaitingCacheInterval === n ? (console.error(window.i18nLocale.ai_response_error), t.resetButton(!1), t.showErrorMessage(window.i18nLocale.ai_response_error)) : i.ajax({
                type: "POST",
                url: window.ajaxurl,
                timeout: 1e4,
                data: e
            }).done(function(e) {
                if (!t.isGenerating) return !1;
                !0 === e.success && e.data && "cache_in_process" !== e.data && (t.$generated_content.val(e.data), t.resetButton(!0), t.$insert_button.show()), !1 === e.success && e && e.data && e.data[0] && e.data[0].code && e.data[0].message && (t.$generated_content.val("stop_cache_timeouts"), t.resetButton(!1), e = e.data[0].message.replace(/\\/g, ""), t.showErrorMessage(e))
            })
        },
        ...
        disableButton: function() {
            this.$generate_button.prop("disabled", function(e, t) {
                return !t
            }), this.isGenerateDisabled = !0
        },
        resetButton: function(e) {
            e = e ? "Regenerate" : this.initialButtonText;
            this.$generate_button.removeAttr("disabled style"), this.$generate_button.text(e), this.$generate_button.blur(), this.clearTimer()
        },
        clearTimer: function() {
        ...
        changePrompt: function(e) {
            ...
            t.length > this.maxPromptLength && (e.target.value = t.slice(0, this.maxPromptLength).join(" "))
        },
        showErrorMessage: function(e) {
            window.vc.showMessage(e, "error", 1e4, "#vc_ui-helper-modal-ai .vc_ui-panel-window-inner")
        },
        insertContent: function() {
            var e = this.$el.find(".wpb_ai-generated-content").val();
            if (!e) return !1;
            var t, n, i = this.$el.data();
            "textarea_html" === i.param_type || "content" === i.fieldId ? (n = (t = i.element).attr("id"), "new_content" === this.contentType && (e = t.val() + " " + e), (n = window.tinymce.get(n)) && n.setContent(e), t.val(e).trigger("input").trigger("change").trigger("blur")) : ["textarea", "textfield", "textarea_raw_html"].includes(i.param_type) ? (n = i.element, "new_content" === this.contentType && (e = n.val() + " " + e), n.val(e).trigger("input").trigger("change").trigger("blur")) : i.fieldId && (["wpb_css_editor", "wpb_js_header_editor", "wpb_js_footer_editor"].includes(i.fieldId) ? (e = window.ace.edit(i.fieldId).getValue() + "\n\n" + e, window.ace.edit(i.fieldId).setValue(e).trigger("input").trigger("change").trigger("blur")) : i.element && i.element.length && ("new_content" === this.contentType && (e = i.element.val() + " " + e), i.element.val(e).trigger("input").trigger("change").trigger("blur"))), this.$close_button.click()
        },
        toggleModalPromoClass: function(e) {
            "promo" === e ? this.$el.addClass("vc_modal-ai-container--promo") : this.$el.removeClass("vc_modal-ai-container--promo")
        },
        hideFormFields: function(n) {
            this.$form.find("div[data-optional-form-field]").each(function() {
                var e = i(this),
                    t = e.attr("data-optional-form-field");
                n.includes(t) ? e.show() : e.hide()
            })
        }
    })
}(window.jQuery);
